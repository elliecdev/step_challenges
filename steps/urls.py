...
from . import views
from .views import FrontendLoginView, LeaderboardView, StepEntryCreateView, StepEntryListView, HomeView


urlpatterns = [
    path('', HomeView.as_view(), name='steps-home'),
    path("leaderboard/", LeaderboardView.as_view(), name="steps-leaderboard"),
